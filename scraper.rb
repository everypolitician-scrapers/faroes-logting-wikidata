...
def candidates
  morph_api_url = 'https://api.morph.io/tmtmtmtm/faroes-logting-wikipedia/data.json'
  morph_api_key = ENV["MORPH_API_KEY"]
  result = RestClient.get morph_api_url, params: {
    key: morph_api_key,
    query: "select DISTINCT(identifier__wikipedia_fo) as wikiname from data"
  }
  JSON.parse(result, symbolize_names: true)
end

def wikidata_ids(names)
  client = MediawikiApi::Client.new "https://fo.wikipedia.org/w/api.php"
