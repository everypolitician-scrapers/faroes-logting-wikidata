...
no[1990] = EveryPolitician::Wikidata.wikipedia_xpath(
  ...
  xpath: '//table[contains(@class,"navbox")]//td[contains(@class,"navbox-list")]//a[not(@class="new")]/@title',
)
...
EveryPolitician::Wikidata.scrape_wikidata(names: { fo: names_fo, no: no.values.inject(&:|) })
